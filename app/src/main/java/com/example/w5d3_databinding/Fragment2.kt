...
import com.example.w5d3_databinding.databinding.SecondFragmentLayoutBinding
...
class Fragment2 : Fragment(){
    ...
    override fun onCreateView(
        ...
        val binding : SecondFragmentLayoutBinding =
            DataBindingUtil.inflate(inflater, R.layout.second_fragment_layout, container, false)
